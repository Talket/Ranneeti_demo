/**
 * ============================================
 * VYUHA - Criminal Network Analysis Platform
 * A React-based intelligence tool for visualizing and analyzing criminal networks
 * Built with React, Lucide Icons, and Tailwind CSS
 * ============================================
 */
...
// ============================================
// SECTION 1: DESIGN SYSTEM & STYLING CONSTANTS
// ============================================
const COLORS = {
  bgApp: '#181B21',
  bgPanel: '#22262E',
...
// ============================================
// SECTION 2: MOCK DATA & CASE CONFIGURATION
// ============================================
const MOCK_CASE = {
...
// ============================================
// Shared UI building blocks used throughout the application
...
// ============================================
// Central App component managing global state and view routing
...
// ============================================
// SECTION 5: VIEW COMPONENTS
// ============================================
// Modular view components for different application pages

/**
 * WorkspaceView
 * Interactive graph visualization of criminal network nodes and connections
 * Features: Pan, zoom, node selection, connection approval/rejection
 */
  // Graph Canvas State
...
/**
 * DashboardView
 * Operational analytics dashboard showing system statistics and alerts
 */
  return (
...
/**
 * AlertsView
 * System alerts and notifications for important events and anomalies
 */
  const alerts = [
...
/**
 * ReviewView
 * Data extraction verification interface
 * Allows officers to review LLM-extracted JSON against source documents
 */
  return (
...
/**
 * PlaceholderView
 * Placeholder view for future features not yet implemented in prototype
 */
  return (
...
// ============================================
// The App component is the main export and entry point
// It manages global state and routes between different views